...
| 模式 | Top-1 | Top-3 | MRR | P50 | P95 |
|------|-------|-------|-----|-----|-----|
| text | 58.6% | 65.5% | 0.684 | 825ms | 1552ms |
| hybrid | 58.6% | **69.0%** | **0.787** | 2039ms | 3152ms |
| hybrid + 快速路径 | 58.6% | 69.0% | 0.787 | **~800ms** | **~1800ms** |
